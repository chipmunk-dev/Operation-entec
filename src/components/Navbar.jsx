...
[전체 기능] PDF 설명서 서비스별 기능·입력·결과 구분 개선
...
[공통 화면] 개선활동 기간 표기 폭 조정
[아이체크 보고] 13열 입력 반영
[G-EMS 메세지] 출력 설정 12시간 저장
[G-EMS 메세지] 단일 메시지 처리 개선
[자동 백업 에러] 데이터 관리·TXT 내보내기 개선
[공통 화면] 헤더·입력 영역 간소화
[전체 기능] 중복 작업순서 안내 제거
[전체 기능] 입력 예시 근무자명 통일`,
  },
  {
    date: '2026.08',
    title: '기능 통합',
    detail: `[해외메일 작성] 구분선·간격 개선
[지속 이벤트 재전달] 해외메일 양식 개선
[G-EMS 메세지] 화면·출력 문구 개선
[아이체크 보고] 담당자별 보고 기능 추가
[전체 기능] 사용방법 안내 추가
[공통 화면] 배포 새로고침 알림 추가
[공통 화면] 화면 디자인 개선`,
  },
  {
    date: '2026.07',
    title: '보고 자동화 확장',
    detail: `[자동 백업 에러] 백업 JSON 공유 추가
[지속 메시지 엑셀 추출] 엑셀 보고 추가
[지속 메시지 엑셀 추출] 담당자 판독 개선
[지속 이벤트 재전달] Event 처리 개선`,
  },
  {
    date: '2026.02~06',
    title: '현업 적용·규칙 정리',
    detail: `[전체 기능] 현업 예외 입력 반영 및 처리 기준 정리
[전체 기능] 반복 사용 결과를 바탕으로 출력 양식 보완`,
  },
  {
    date: '2026.01',
    title: '메일 양식 개선',
    detail: '[해외메일 작성] 본문 간격·출력 형식 개선',
  },
  {
    date: '2025.12',
    title: '협업 기능 시작',
    detail: `[지속 이벤트 재전달] 대기·확인 관리 추가
[지속 이벤트 재전달] 국내·해외 전달 문구 추가`,
  },
];
